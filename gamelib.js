...
let key = {pressed:{},space:32,enter:13,left:37,up:38,right:39,down:40,F1:112,F2:113,F3:114,F4:115,F5:116,F6:117,F7:118,F8:119,F9:120,F10:121,F11:122,F12:123,};
//Font Object
class Font{
...
class Animation extends Sprite{
  ...
  draw(x,y){
    ...
    this.frame += this.framerate;
      ...
      // if direction is left, make game context flipped horizontally
    if(this.direction == "left"){
      this.game.context.save();
      this.game.context.scale(-1, 1);
      this.game.context.translate(-pos.x, pos.y);
      this.game.context.drawImage(this.image,col * this.frameWidth,row * this.frameHeight, this.frameWidth, this.frameHeight, -(this.frameWidth * this.scale / 2),- (this.frameHeight * this.scale / 2),this.frameWidth * this.scale, this.frameHeight * this.scale);
      this.game.context.restore();
    }else{
      this.game.context.scale(1, 1);
